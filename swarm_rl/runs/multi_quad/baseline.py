...
QUAD_BASELINE_CLI_8 = (
    ...
    '--quads_use_numba=True --quads_num_agents=8 --quads_mode=dynamic_same_goal --quads_episode_duration=15.0 '
    ...
    '--normalize_returns=False --reward_clip=10.0 --save_milestones_sec=3600 --quads_use_obstacles=False'
)

_experiment = Experiment(
    'quad_mix_baseline-8_dynamic_same_goal',
    QUAD_BASELINE_CLI_8,
    _params.generate_params(randomize=False),
)

RUN_DESCRIPTION = RunDescription('quads_multi_dynamic_same_goal_baseline_8a_local_v116', experiments=[_experiment])